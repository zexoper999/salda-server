...
@Module({
  imports: [AuthModule],
  controllers: [AdminAuthController, AdminBannersController, AdminUsersController, AdminSubscriptionsController],
  providers: [AdminAuthService, AdminBannersService, AdminUsersService, AdminSubscriptionsService, PrismaService],
